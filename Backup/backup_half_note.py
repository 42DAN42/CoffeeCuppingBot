...
class CoffeeCuppingBot:
    ...
    def rate_coffee(self, update: Update, context: CallbackContext) -> int:
        ...
        if rating.isdigit() and 1 <= int(rating) <= 10:
            ...
            if current_criterion + 1 < len(self.cuppings_criteria):
                ...
                self.logger.info(f"Coffee ratings after evaluation: {self.ratings}")
    ...
    def __init__(self, token):
        ...
        self.notes = {}
        # Флаг для отслеживания завершения оценки
        ...
        self.ratings = {}
        self.notes = {}
        self.evaluation_completed = False  # Флаг для отслеживания завершения оценки
